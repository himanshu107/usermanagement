...
const HTML_FOLDER = "C:\Users\Himanshu\git\modelmugging\src\main\webapp\static\front";  // folder with your HTML files
// Valid search fields: "title", "description", "keywords", "body"
const SEARCH_FIELDS = ["title", "description", "keywords", "body" ,"div"];
...
function readHtml(root, file, fileId) {
    ...
    var div = $("div").text();
    if (typeof div == 'undefined') div = file;
